...
*/     
			{
				.gpu_freq = 200000000/*266667000*/,
				.bus_freq = 3,
			},
			{
				.gpu_freq = 200000000/*228571000*/,
				.bus_freq = 2,
			},
			{
				.gpu_freq = 200000000/*200000000*/,
				.bus_freq = 1,
			},
#else
			{
...
struct clk_lookup msm_clocks_8x60[] = {
	...
	CLK_8X60("gsbi_uart_clk",	GSBI12_UART_CLK, "msm_serial_hsl.0",
			OFF),
#if !defined(CONFIG_USA_MODEL_SGH_I727) && !defined(CONFIG_USA_MODEL_SGH_T989) && !defined(CONFIG_USA_MODEL_SGH_I717) && !defined(CONFIG_USA_MODEL_SGH_I757)&&! defined (CONFIG_USA_MODEL_SGH_T769)&& !defined(CONFIG_USA_MODEL_SGH_I577)//qup_a2220
	...
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_s5k6aafx.0", OFF),
#elif defined (CONFIG_USA_MODEL_SGH_I757)
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_sr200pc20m.0", OFF),
#else
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_s5k5bafx.0", OFF),
...
#if defined (CONFIG_USA_MODEL_SGH_T769)|| defined (CONFIG_USA_MODEL_SGH_I577) 
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_s5k6aafx.0", OFF),
#elif defined (CONFIG_USA_MODEL_SGH_I757)
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_sr200pc20m.0", OFF),
#else
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_s5k5bafx.0", OFF),
#ifdef CONFIG_CAMERA_VE
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	  "msm_camera_sr200pc20m.0", OFF),
#endif
#endif
...
#if defined (CONFIG_USA_MODEL_SGH_T769)|| defined (CONFIG_USA_MODEL_SGH_I577) 
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_s5k6aafx.0", OFF),
#elif defined (CONFIG_USA_MODEL_SGH_I757)
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_sr200pc20m.0", OFF),
#else
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_s5k5bafx.0", OFF),
#ifdef CONFIG_CAMERA_VE
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	  "msm_camera_sr200pc20m.0", OFF),
#endif
#endif
