...
#endif  //CONFIG_KOR_MODEL_SHV_E160
#endif
...
static struct gpiomux_setting gyro_suspend_cfg = {
	...
	||defined(CONFIG_KOR_MODEL_SHV_E120S)||defined(CONFIG_KOR_MODEL_SHV_E120K)||defined(CONFIG_KOR_MODEL_SHV_E120L) || defined(CONFIG_KOR_MODEL_SHV_E160L)
...
#if defined(CONFIG_KOR_MODEL_SHV_E120S) || defined(CONFIG_KOR_MODEL_SHV_E120K) || defined (CONFIG_USA_MODEL_SGH_I717) \
    || defined (CONFIG_USA_MODEL_SGH_T769) || defined (CONFIG_KOR_MODEL_SHV_E160S) || defined (CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_JPN_MODEL_SC_05D)
...
#endif	
//#if defined(CONFIG_JPN_MODEL_SC_05D)//-> Temporary for REV04 B'd and below, it'll be deleted later
#if 0
	{
		.gpio      = 72,
		.settings = {
...
#if defined(CONFIG_KOR_MODEL_SHV_E120L) || defined(CONFIG_KOR_MODEL_SHV_E120S) || defined(CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160L)\
...
msm8x60_charm_gpiomux_cfgs[] __initdata = {
    ...
    && !defined(CONFIG_USA_MODEL_SGH_I757) && !defined (CONFIG_USA_MODEL_SGH_T769) && !defined(CONFIG_USA_MODEL_SGH_I757) && !defined(CONFIG_USA_MODEL_SGH_I577) && !defined(CONFIG_KOR_MODEL_SHV_E120L) \
    && !defined(CONFIG_JPN_MODEL_SC_05D)
	{msm8x60_common_configs, ARRAY_SIZE(msm8x60_common_configs)},
#endif
	{msm8x60_cam_configs, ARRAY_SIZE(msm8x60_cam_configs)},
