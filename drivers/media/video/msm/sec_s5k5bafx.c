...
#elif defined (CONFIG_KOR_MODEL_SHV_E160S) || defined (CONFIG_KOR_MODEL_SHV_E160K) || defined(CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_JPN_MODEL_SC_05D)
#include "sec_s5k5bafx_reg_q1.h"
#elif defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K)|| defined (CONFIG_KOR_MODEL_SHV_E120L)
#include "sec_s5k5bafx_reg_dali.h"
#else
...
#if defined (CONFIG_TARGET_LOCALE_KOR) || defined (CONFIG_JPN_MODEL_SC_03D) || defined(CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_JPN_MODEL_SC_05D)
	if(s5k5bafx_ctrl->check_dataline)
		return 0;
...
#if defined (CONFIG_JPN_MODEL_SC_03D) || defined (CONFIG_JPN_MODEL_SC_05D)//50Hz
#ifdef I2C_BURST_MODE
