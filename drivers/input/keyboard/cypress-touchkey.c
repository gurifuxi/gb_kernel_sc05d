...
static int touchkey_keycode[] = {NULL, KEY_BACK, KEY_ENTER, KEY_MENU, KEY_END}; // BEHOLD3
  ...
  || defined (CONFIG_KOR_MODEL_SHV_E120S)|| defined (CONFIG_KOR_MODEL_SHV_E110S) || defined (CONFIG_KOR_SHV_E120L_HD720) \
  || defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) \
  || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined (CONFIG_USA_MODEL_SGH_T769) \
  || defined(CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_JPN_MODEL_SC_05D)
...
#if defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_SHV_E120L_HD720) || defined (CONFIG_KOR_MODEL_SHV_E120K) \
...
#if !defined(CONFIG_USA_MODEL_SGH_I717) && !defined (CONFIG_KOR_MODEL_SHV_E110S) \
&& !defined (CONFIG_KOR_SHV_E120L_HD720) && !defined (CONFIG_KOR_MODEL_SHV_E120S) && !defined (CONFIG_KOR_MODEL_SHV_E120K) \
...
extern int tkey_led_vdd_enable(int onoff);
     ...
     || defined (CONFIG_KOR_SHV_E120L_HD720) || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined (CONFIG_KOR_MODEL_SHV_E110S) \
     || defined(CONFIG_JPN_MODEL_SC_05D)
static int press_check = NULL;
#endif
...
static irqreturn_t touchkey_interrupt(int irq, void *dummy)  // ks 79 - threaded irq(becuase of pmic gpio int pin)-> when reg is read in work_func, data0 is always release. so temporarily move the work_func to threaded irq.
{
    ...
    #if defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_JPN_MODEL_SC_05D)// Temporary Code 
    // if (get_hw_rev() <= 0x04){
        tkey_vdd_enable(1); 
    // }
    #endif 
    ...
    #if defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) // Temporary Code 
	if (get_hw_rev() <= 0x04){
        if (data[0] > 80)  {
            data[0] = data[0] - 80; 
...
#endif // defined (CONFIG_USA_MODEL_SGH_T989)||defined (CONFIG_USA_MODEL_SGH_I727) ||defined(CONFIG_USA_MODEL_SGH_T769)
	init_hw();
...
#if defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L)\
     || defined (CONFIG_KOR_SHV_E120L_HD720) || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) \
     || defined (CONFIG_JPN_MODEL_SC_05D) || defined (CONFIG_USA_MODEL_SGH_I717)
			msleep(100);
#endif
			if(!touchkey_enable )
				touchkey_enable = 1; 
...
#if defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L)\
     || defined (CONFIG_KOR_SHV_E120L_HD720) || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined (CONFIG_USA_MODEL_SGH_I717) \
     || defined (CONFIG_JPN_MODEL_SC_05D)
		enable_irq(IRQ_TOUCHKEY_INT);
		touchkey_enable = 1;
		msleep(50);
...
#if defined(CONFIG_USA_MODEL_SGH_T989)||defined (CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
    {
      touchkey_auto_calibration(1/*on*/);
    }
    mdelay(30);	
...
#elif defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I577)
...
static ssize_t touch_led_control(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
	...
	int int_data=0;
	int errnum=0;
#if defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined(CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_JPN_MODEL_SC_05D)
...
|| defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_USA_MODEL_SGH_T769)
...
#elif defined (CONFIG_KOR_SHV_E120L_HD720) || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) \
 || defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_JPN_MODEL_SC_05D)
		int_data = int_data *0x10;
#else
...
|| defined (CONFIG_KOR_SHV_E120L_HD720) || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) \
...
{
	int ret = 0;
#if defined (CONFIG_KOR_MODEL_SHV_E110S) || defined (CONFIG_KOR_SHV_E120L_HD720) || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_JPN_MODEL_SC_05D)
	int retry = 3;
#else
	int retry = 10;
#endif
...
#elif defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_USA_MODEL_SGH_I577) || defined(CONFIG_JPN_MODEL_SC_05D)
		set_irq_type(IRQ_TOUCHKEY_INT, IRQ_TYPE_EDGE_FALLING);
#elif defined (CONFIG_USA_MODEL_SGH_T989) || defined (CONFIG_USA_MODEL_SGH_T769)
	if (get_hw_rev() >= 0x0d){
		set_irq_type(IRQ_TOUCHKEY_INT, IRQ_TYPE_EDGE_RISING);	
...
#if !defined (CONFIG_KOR_SHV_E120L_HD720) && !defined (CONFIG_KOR_MODEL_SHV_E120S) && !defined (CONFIG_KOR_MODEL_SHV_E120K) \
	&& !defined (CONFIG_KOR_MODEL_SHV_E110S) && !defined (CONFIG_KOR_MODEL_SHV_E160S) && !defined(CONFIG_KOR_MODEL_SHV_E160K) \
...
#elif defined(CONFIG_USA_MODEL_SGH_I757)
	if( (data[1] < 0x03) && (data[2] == 0x02) ) // FW : 2011.10.12 // Ver : 0x03
	{
		printk("%s : update 757 tkey...\n",__func__);
		extern int ISSP_main(int touchkey_pba_rev);
		set_touchkey_debug('U');
		while (retry--) {
			if (ISSP_main(NULL) == 0) {
...
printk("%s : update SHV_E120L_WXGA tkey...\n",__func__);	
	...
	/*if (
		((get_hw_rev() >= 0x04) && (data[1] != 0x07) && (data[1] != 0x00)) 
...
/*	if (   ((get_hw_rev() >= 0x0a) && (data[1] != 0x12)&& (data[1] != 0x00)) 
		|| ((get_hw_rev() == 0x08) && (data[1] != 0x05)&& (data[1] != 0x00)) 
		|| ((get_hw_rev() == 0x06) && (data[1] != 0x03)&& (data[1] != 0x00))
		|| ((get_hw_rev()  < 0x06) && (data[1] != 0x02)&& (data[1] != 0x00))	) 
    {
